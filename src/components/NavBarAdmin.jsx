...
/>
    ...
    <div className={`sidebar ${isSidebarOpen ? 'open' : ''}`}>
      <nav className="sidebar-nav">
        <button className="nav-item" onClick={() => { navigate('/viewusers'); setSidebarOpen(false); }}>Users</button>
        <button className="nav-item" onClick={() => { navigate('/viewprofessionals'); setSidebarOpen(false); }}>Professionals</button>
        <button className="nav-item" onClick={() => { navigate('/proffessionalsignup'); setSidebarOpen(false); }}>Add Professionals</button>
        <button className="nav-item" onClick={() => { navigate('/viewfeedback'); setSidebarOpen(false); }}>Feedbacks</button>
