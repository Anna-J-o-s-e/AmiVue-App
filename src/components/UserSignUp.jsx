...
const UserSignUp = () => {
  ...
  const validateForm = () => {
    ...
    if (!data.agreePolicy) newErrors.agreePolicy = "You are required to agree to the health policy";
  ...
  const readValue = async () => {
    if (validateForm()) {
      ...
      if (data.profilePicture) {
        formData.append("profilePicture", data.profilePicture); // Only append if user uploaded
      }
  ...
  return (
    <div className="signup-container">
      <div className="signup-box">
        ...
        <p className="signup-subtitle">Join us and take care of your eye health</p>
